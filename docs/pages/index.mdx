...
<div className="flex flex-wrap gap-5 mt-4">
  ...
  />
  <img src="/rocketmoney_logo.svg" alt="Rocket Money" className="h-6" />
  <img src="/samsara_dark.png" alt="Samsara" className="h-6 dark:hidden" />
  <img
    src="/samsara_light.png"
    alt="Samsara"
    className="h-6 hidden dark:block"
  />
  <img src="/twilio_logo_light.svg" alt="Twilio" className="h-6 dark:hidden" />
  <img
    src="/twilio_logo_dark.svg"
    alt="Twilio"
    className="h-6 hidden dark:block"
  />
  <img src="/adobe_logo.svg" alt="Adobe" className="h-6" />

  <img src="/fletch_dark.svg" alt="Fletch" className="h-6" />
  <img src="/cornelsen_logo.png" alt="Cornelsen" className="h-6" />
  <img src="/weather_logo.svg" alt="The Weather Company" className="h-6" />
</div>
